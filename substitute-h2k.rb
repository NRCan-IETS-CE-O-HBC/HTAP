...
# =========================================================================================
def WindowsRoadmapping_RuleSet( ruleType, elements )
   if ruleType =~ /windows_roadmapping_gas/
   ...
   elsif ruleType =~ /windows_roadmapping_elec/
    if $gChoices["Opt-Archetype"] =~ /pre-1946/
   ...
   elsif ruleType =~ /windows_roadmapping_oil/
    if $gChoices["Opt-Archetype"] =~ /pre-1946/
...
if !$ruleSetName.empty? && $ruleSetName != "NA"
   ...
   elsif ( $ruleSetName =~ /windows_roadmapping/) 
      stream_out ("  (f) ")
      WindowsRoadmapping_RuleSet( $ruleSetName, h2kElements )	

   elsif ( $ruleSetName =~ /north_testing/) 
      stream_out ("  (f) ")
      NorthTesting_RuleSet( $ruleSetName, h2kElements )	
