...
# Setting Frostline Depth
# Sources - "ESTIMATING THE DEPTH OF PAVEMENT FROST AND THAW PENETRATIONS" by G. H. Argue and B. B. Denyes
#         - "Foundation Frost Penetration Depths for Southern Ontario" (2010) OPSD 3090.101
$Frostline =  {
            "WHITEHORSE" =>  3.2,
            "TORONTO" => 1.2 ,
            "OTTAWA" => 1.8 ,
