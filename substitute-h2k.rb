...
def ChangeWinCodeByOrient( winOrient, newValue, h2kCodeLibElements, h2kFileElements, choiceEntryValue, tagValue )
  ...
  $useThisCodeID  = {  
    "S"  =>  191 ,    "SE" =>  192 ,    "E"  =>  193 ,    "NE" =>  194 ,    "N"  =>  195 ,    "NW" =>  196 ,    "W"  =>  197 ,    "SW" =>  198   
  }
...
def ChangeSkylightCodeByOrient( winOrient, newValue, h2kCodeLibElements, h2kFileElements, choiceEntryValue, tagValue )
  ...
  $useThisCodeID  = { 
    "S"  =>  201 , "SE" =>  202 , "E"  =>  203 , "NE" =>  204 , "N"  =>  205 , "NW" =>  206 , "W"  =>  207 , "SW" =>  208   
  }
...
def ChangeDoorWinCodeByOrient( winOrient, newValue, h2kCodeLibElements, h2kFileElements, choiceEntryValue, tagValue )
  ...
  $useThisCodeID = { 
    "S"  =>  211 ,"SE" =>  212 ,"E"  =>  213 ,"NE" =>  214 ,"N"  =>  215 ,"NW" =>  216 ,"W"  =>  217 ,"SW" =>  218 
  }
...
def postprocess( scaleData )
  ...
  h2kPostElements["HouseFile/AllResults"].elements.each do |element|
    ...
    if (houseCode == nil && element.attributes["sha256"] != nil) then
      houseCode = "General"
    end

    # JTB 31-Jan-2018: Limiting results parsing to 1 set specified by user in choice file and saved in $outputHCode
    next if (houseCode !~ /#{$outputHCode}/)

    stream_out( "\n Parsing results from set: #{$outputHCode} ...")

    # Energy Consumption (Annual GJ)
    $gResults[houseCode]["Energy-Total-GJ"]        = element.elements[".//Annual/Consumption"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["Energy-HeatingGJ"]      = element.elements[".//Annual/Consumption/SpaceHeating"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["Gross-HeatLoss-GJ"]      = element.elements[".//Annual/HeatLoss"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["Energy-CoolingGJ"]      = element.elements[".//Annual/Consumption/Electrical"].attributes["airConditioning"].to_f * scaleData
    $gResults[houseCode]["Energy-VentGJ"]  = element.elements[".//Annual/Consumption/Electrical"].attributes["ventilation"].to_f * scaleData
    $gResults[houseCode]["Energy-PlugGJ"]    = element.elements[".//Annual/Consumption/Electrical"].attributes["baseload"].to_f * scaleData
    $gResults[houseCode]["Energy-DHWGJ"] = element.elements[".//Annual/Consumption/HotWater"].attributes["total"].to_f * scaleData
    ...
    if $ExtraOutput1 then
      ...
      $gResults[houseCode]["HotWaterLoadGJ"] = element.elements[".//Annual/HotWaterDemand"].attributes["base"].to_f * scaleData
    end

    # Design loads, other data
    $gResults[houseCode]["PEAK-Heating-W"] = element.elements[".//Other"].attributes["designHeatLossRate"].to_f * scaleData
    $gResults[houseCode]["PEAK-Cooling-W"] = element.elements[".//Other"].attributes["designCoolLossRate"].to_f * scaleData

    $gResults[houseCode]["SeasonalHeatEff"] = element.elements[".//Other"].attributes["seasonalHeatEfficiency"].to_f * scaleData
    $gResults[houseCode]["VntAirChangeRateNatural"] = element.elements[".//Annual/AirChangeRate"].attributes["natural"].to_f * scaleData
    $gResults[houseCode]["VntAirChangeRateTotal"] = element.elements[".//Annual/AirChangeRate"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["Useful-Solar-Gain-GJ"] = element.elements[".//Annual/UtilizedSolarGains"].attributes["value"].to_f * scaleData
    $gResults[houseCode]["VntMinAirChangeRate"] = element.elements[".//Other/Ventilation"].attributes["minimumAirChangeRate"].to_f * scaleData
    ...
    $gResults[houseCode]["EnergyElec_SpaceHeating_GJ"] = element.elements[".//Annual/Consumption/Electrical"].attributes["spaceHeating"].to_f * scaleData
    $gResults[houseCode]["EnergyGas_SpaceHeating_GJ"] = element.elements[".//Annual/Consumption/NaturalGas"].attributes["spaceHeating"].to_f * scaleData
    $gResults[houseCode]["EnergyOil_SpaceHeating_GJ"] = element.elements[".//Annual/Consumption/Oil"].attributes["spaceHeating"].to_f * scaleData
    $gResults[houseCode]["EnergyProp_SpaceHeating_GJ"] = element.elements[".//Annual/Consumption/Propane"].attributes["spaceHeating"].to_f * scaleData
    $gResults[houseCode]["EnergyWood_SpaceHeating_GJ"] = element.elements[".//Annual/Consumption/Wood"].attributes["spaceHeating"].to_f * scaleData
    $gResults[houseCode]["EnergyElec_WaterHeating_GJ"] = element.elements[".//Annual/Consumption/Electrical/HotWater"].attributes["dhw"].to_f * scaleData
    $gResults[houseCode]["EnergyGas_WaterHeating_GJ"] = element.elements[".//Annual/Consumption/NaturalGas"].attributes["hotWater"].to_f * scaleData
    $gResults[houseCode]["EnergyOil_WaterHeating_GJ"] = element.elements[".//Annual/Consumption/Oil"].attributes["hotWater"].to_f * scaleData
    $gResults[houseCode]["EnergyProp_WaterHeating_GJ"] = element.elements[".//Annual/Consumption/Propane"].attributes["hotWater"].to_f * scaleData
    $gResults[houseCode]["EnergyWood_WaterHeating_GJ"] = element.elements[".//Annual/Consumption/Wood"].attributes["hotWater"].to_f * scaleData


    $gResults[houseCode]["EnergyElec_Total_GJ"]    = element.elements[".//Annual/Consumption/Electrical"].attributes["total"].to_f * scaleData
    ...
    #if !$PVIntModel && $gResults[houseCode]["EnergyElec_GJ"] == 0 then
    #  $gResults[houseCode]["EnergyElec_GJ"] = element.elements[".//Annual/Consumption/Electrical"].attributes["baseload"].to_f * scaleData +
    ...
    #end
    $gResults[houseCode]["EnergyGas_Total_GJ"]  = element.elements[".//Annual/Consumption/NaturalGas"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["EnergyOil_Total_GJ"]     = element.elements[".//Annual/Consumption/Oil"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["EnergyPropane_Total_GJ"] = element.elements[".//Annual/Consumption/Propane"].attributes["total"].to_f * scaleData
    $gResults[houseCode]["EnergyWood_Total_GJ"]    = element.elements[".//Annual/Consumption/Wood"].attributes["total"].to_f * scaleData

    $gResults[houseCode]["EnergyElec_Total_KWH"]  = $gResults[houseCode]["EnergyElec_Total_GJ"] * 277.77777778
    $gResults[houseCode]["EnergyGas_Total_M3"]    = $gResults[houseCode]["EnergyGas_Total_GJ"] * 26.853
    $gResults[houseCode]["EnergyOil_Total_L"]     = $gResults[houseCode]["EnergyOil_Total_GJ"]  * 25.9576
    $gResults[houseCode]["EnergyPropane_Total_L"] = $gResults[houseCode]["EnergyPropane_Total_GJ"] / 25.23 * 1000
    $gResults[houseCode]["EnergyWood_Total_Cord"] = $gResults[houseCode]["EnergyWood_Total_GJ"] / 18.30
    ...
    if ( $PVIntModel )
      ...
      # GJ
      $gResults[houseCode]["Energy-PV-kWh"] = $gResults[houseCode]["avgEnergyPVAvailableGJ"] * 277.777778
      # kWh
      ...
      netAnnualPV = $gResults[houseCode]["Energy-PV-kWh"] - $gResults[houseCode]["avgElecPVUsedkWh"]
      if ( netAnnualPV > 0 )
      ...
      $gResults[houseCode]["Energy-PV-kWh"] = 0.0
  ...
  $gAvgEnergy_Total = $gResults[$outputHCode]["EnergyElec_Total_GJ"] + $gResults[$outputHCode]["EnergyGas_Total_GJ"] +
  $gResults[$outputHCode]["EnergyOil_Total_GJ"] + $gResults[$outputHCode]["EnergyPropane_Total_GJ"] +
  $gResults[$outputHCode]["EnergyWood_Total_GJ"]
  ...
  if ( $PVIntModel )
    ...
    if ( $gResults[$outputHCode]["avgFueluseElecGJ"] > $gEnergyPV )
      ...
      $gResults[$outputHCode]["EnergyEleckWh"] = $gResults[$outputHCode]["avgFueluseElecGJ"] * 277.77777778
      ...
      $gResults[$outputHCode]["EnergyEleckWh"] = 0.0
      # New electricity cost is just the monthly minimum (also update total fuel cost)!
      calcElectCost( "annualMin" )
    end
    $gResults[$outputHCode]["Energy-PV-kWh"] = $gResults[$outputHCode]["avgEnergyPVAvailableGJ"] * 277.777778
    # kWh
    $gResults[$outputHCode]["avgElecPVUsedkWh"] = $gResults[$outputHCode]["avgEnergyPVUtilizedGJ"] * 277.777778
    # kWh

    netAnnualPV = $gResults[$outputHCode]["Energy-PV-kWh"] - $gResults[$outputHCode]["avgElecPVUsedkWh"]
    if ( netAnnualPV > 0 )
  ...
  stream_out  "\n Peak Heating Load (W): #{$gResults[$outputHCode]['PEAK-Heating-W'].round(1)}  \n"
  stream_out  " Peak Cooling Load (W): #{$gResults[$outputHCode]['PEAK-Cooling-W'].round(1)}  \n"

  stream_out("\n Energy Consumption: \n\n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-HeatingGJ'].round(1)} ( Space Heating, GJ ) \n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-DHWGJ'].round(1)} ( Hot Water, GJ ) \n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-VentGJ'].round(1)} ( Ventilator Electrical, GJ ) \n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-CoolingGJ'].round(1)} ( Space Cooling, GJ ) \n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-PlugGJ'].round(1)} ( Appliances + Lights + Plugs + outdoor, GJ ) \n")
  stream_out ( " --------------------------------------------------------\n")
  stream_out ( "  #{$gResults[$outputHCode]['Energy-Total-GJ'].round(1)} ( H2K Gross energy use GJ ) \n")
  ...
  stream_out("  - #{$gResults[$outputHCode]['EnergyElec_Total_KWH'].round(0)} (Total Electricity, kWh)\n")
  stream_out("  - #{$gResults[$outputHCode]['EnergyGas_Total_M3'].round(0)} (Total Natural Gas, m3)\n")
  stream_out("  - #{$gResults[$outputHCode]['EnergyOil_Total_L'].round(0)} (Total Oil, l)\n")
  stream_out("  - #{$gResults[$outputHCode]['EnergyPropane_Total_L'].round(0)} (Total Propane, l)\n")

  # ASF 03-Oct-2016:
  # Wood/Pellets
  stream_out("  - #{$gResults[$outputHCode]['EnergyWood_Total_Cord'].round(0)} (Total Wood, cord)\n")
...
def calcElectCost( calcType )
  ...
  if ( calcType == "annualMin" )
    ...
    if ( $gResults[$outputHCode]["EnergyEleckWh"] > $gElecRate["ElecBlck1Units"] )
      $gResults[$outputHCode]["avgFuelCostsElec$"] = $gElecRate["ElecBlck1Units"] * $gElecRate["ElecBlck1CostPerUnit"]
      balancekWh = $gResults[$outputHCode]["EnergyEleckWh"] - $gElecRate["ElecBlck1Units"]
      ...
      $gResults[$outputHCode]["avgFuelCostsElec$"] = $gResults[$outputHCode]["EnergyEleckWh"] * $gElecRate["ElecBlck1CostPerUnit"]
    end
  end
...
# Set, parse command line options
...
# if autocosts were estimated, compute costs
...
#if ( $PVIntModel )
#  #$gAvgPVRevenue = ( $gResults[$outputHCode]['Energy-PV-kWh'] - $gResults[$outputHCode]['avgElecPVUsedkWh'] ) * $PVTarrifDollarsPerkWh
#else
#  #$gAvgPVRevenue = ( $gResults[$outputHCode]['Energy-PV-kWh'] - $gResults[$outputHCode]['EnergyEleckWh'] ) * $PVTarrifDollarsPerkWh
#end
...
$MEUI_kWh_m2 =  ( 
  $gResults[$outputHCode]['Energy-HeatingGJ'] +
  $gResults[$outputHCode]['Energy-CoolingGJ'] +
  $gResults[$outputHCode]['Energy-VentGJ'] +
  $gResults[$outputHCode]['Energy-DHWGJ']  
) * 277.78 / $FloorArea

if ( $gResults['Reference'].empty? ) then
  $RefEnergy = 0.0
else
  $RefEnergy = $gResults['Reference']['Energy-Total-GJ']
end
...
results[$aliasLongOutput] = $gResults[$outputHCode]
results[$aliasLongOutput]["HDDs"                        ] = $HDDs
results[$aliasLongOutput]["Ref-En-Total-GJ"             ] = $RefEnergy.round(1)
results[$aliasLongOutput]["AuxEnergyReq-HeatingGJ"      ] = $gAuxEnergyHeatingGJ.round(1)
results[$aliasLongOutput]["TotalAirConditioning-LoadGJ" ] = $TotalAirConditioningLoad.round(1) 
results[$aliasLongOutput]["AvgAirConditioning-COP"      ] = $AvgACCOP.round(1) 
results[$aliasLongOutput]["TEDI_kWh_m2"                 ] = $TEDI_kWh_m2.round(1) 
results[$aliasLongOutput]["MEUI_kWh_m2"                 ] = $MEUI_kWh_m2.round(1) 
results[$aliasLongOutput]["ERS-Value"                   ] = $gERSNum.round(1) 
results[$aliasLongOutput]["NumTries"                    ] = $NumTries.round(1) 
results[$aliasLongOutput]["LapsedTime"                  ] = $runH2KTime.round(2) 
results[$aliasLongOutput]["PEAK-Heating-W"              ] = $gResults[$outputHCode]['PEAK-Heating-W'].round(1) 
results[$aliasLongOutput]["PEAK-Cooling-W"              ] = $gResults[$outputHCode]['PEAK-Cooling-W'].round(1) 
results[$aliasLongOutput]["House-R-Value(SI)"           ] = $RSI['house'].round(3)
